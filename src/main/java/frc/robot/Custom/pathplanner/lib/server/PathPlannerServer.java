package frc.robot.Custom.pathplanner.lib.server;
...
import frc.robot.Custom.org.json.simple.parser.ParseException;
...
public class PathPlannerServer {
  ...
  public static List<PathPlannerServerThread> clients =
