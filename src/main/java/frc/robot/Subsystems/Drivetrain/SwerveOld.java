...
//         lastPose = new Pose2d(2, 2 , Rotation2d.fromDegrees(0));
//         zeroGyro();

//         // new swervelib.SwerveModule(0, Constants.Swerve.Mod0)
//         mSwerveMods = new SwerveModule[] {
//             new swervelib.SwerveModule(0, null)
//         };
//         // mSwerveMods = new SwerveModule[] {
...
//             mod.setDesiredState(null, isOpenLoop, isOpenLoop);
...
//         if (!(Math.abs(pose.getX()) <= Constants.fieldLength && Math.abs(pose.getY()) <= Constants.fieldWidth)) {
//             pose = lastPose;
//         }
