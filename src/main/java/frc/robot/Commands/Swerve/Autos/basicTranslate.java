...
//                 new Pose2d(s_Swerve.getPose().getX(), s_Swerve.getPose().getY(), Rotation2d.fromDegrees(s_Swerve.getYaw().getDegrees())),
...
//                 new Pose2d(s_Swerve.getPose().getX() - position.x, s_Swerve.getPose().getY() + position.y, Rotation2d.fromDegrees(s_Swerve.getYaw().getDegrees())),
//                 config);
