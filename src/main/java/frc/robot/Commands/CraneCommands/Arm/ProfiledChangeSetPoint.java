package frc.robot.Commands.CraneCommands.Arm;
...
public class ProfiledChangeSetPoint extends CommandBase {
    ...
    public void initialize() {
        ...
        if(Robot.isSimulation()){
            ...
            System.out.println(endPoint.position);
        }
    ...
    public static Command createWithTimeout(Supplier<PathPoint> endPointSupplier) {
        return createWithTimeout(()->getCurrentPosWRightHeading(), endPointSupplier).withName(getClosestPathPoint().toString());
    }
